                ...
                <div className={styles.register__box}>
                    ...
                    <form onSubmit={sentData}>
                        <Input
                            title={'name'}
                            type={'text'}
                            changeHandlerFn={changeNameHandler}
                        />
                        <Input
                            title={'email'}
                            type={'email'}
                            changeHandlerFn={changeEmailHandler}
                        />
                        <Input
                            title={'password'}
                            type={'password'}
                            changeHandlerFn={changePasswordHandler}
                        />
                        <Input
                            title={'confirm_password'}
                            type={'password'}
                            changeHandlerFn={changeConfirmPasswordHandler}
                        />
                        <div
                            className='field'
                            style={{ width: '100%', marginTop: '20px', alignItems: 'end' }}>
                            <LinkApp
                                title={'Already has a account'}
                                link={'sign-in'}
                            />
                            <Button
                                ...
                                title={'sign up'}
                                type={'primary'}
                                icon={<MdEditNote size={'20px'} />}
                                clickHandlerFn={sentData}
                            />
                        </div>
                    </form>
                </div>
